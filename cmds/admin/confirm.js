...
module.exports = class ConfirmAnnounceCommand extends Commando.Command {
    ...
    async run(message) {
        ...
        if (title !== null) {
            ...
            .setColor('#00309d')
            .setAuthor(title, 'https://cdn.discordapp.com/attachments/682219767230365742/756421904138502245/furry.PNG', titleURL)
            .setDescription(descriptionAnn)
            .setImage(imageURL)
            .setFooter(footer, 'https://cdn.discordapp.com/attachments/682219767230365742/756421904138502245/furry.PNG');
            ...
            this.client.annInfo = {
                ...
                fs.writeFileSync('/UltimateG/json/annInfo.json', JSON.stringify (this.client.annInfo, null, 4), err => {
                    if (err) {
                        throw err;
                    } else {
